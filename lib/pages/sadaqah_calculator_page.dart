...
class _SadaqahCalculatorPageState extends State<SadaqahCalculatorPage> {
  ...
  String _getRandomQuote() {
    final random = DateTime.now().millisecondsSinceEpoch % _sadaqahQuotes.length;
                            ...
                            children: [
                              ..._percentageOptions.map((percentage) {
                                return ChoiceChip(
                                  ...
                                  selected: !_isCustomPercentage && _selectedPercentage == percentage,
                                  onSelected: (selected) {
                                    if (selected) {
                                      setState(() {
  ...
  void _calculateSadaqah() {
    ...
    try {
      ...
      final percentage = _isCustomPercentage 
      ...
      showModalBottomSheet(
        ...
        builder: (context) => Container(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.volunteer_activism, size: 48, color: Colors.green),
              const SizedBox(height: 16),
              Text(
                'نتيجة حساب الصدقة',
